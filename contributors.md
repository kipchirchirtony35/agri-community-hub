...
| Okolla Immaculate | [okolla-immaculate](https://github.com/okolla-immaculate) | Backend                                                                                                          | Add the weather feature,setup express backend,configure cors, set up .env,Prepare backend for deployment.                                                                                                                                                                                     |
